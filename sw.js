const CACHE_NAME = 'vr-explorer-v1.7'; // Incremented version

// **IMPORTANT:** Updated path to match your new GitHub repo
const REPO_PATH = '/ExplorerTest21/';
const ASSETS_TO_CACHE = [
    ...
    'https://unpkg.com/aframe-simple-slider@1.1.0/dist/aframe-simple-slider.min.js'
];
